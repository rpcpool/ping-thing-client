...
const BLOCKLISTS = process.env.BLOCKLISTS || [""];
...
console.log(gBlockhash);
        ...
        while (true) {
          ...
          try {
            await safeRace([
              sendTx(finalTxToSendToRpcAfterAllTheFuckloadOfEncodings),
    ...
    body: JSON.stringify({
      ...
      params: [
        tx,
        {
          skipPreflight: false,
          maxRetries: 0,
          // blocklistPdas: Buffer.from(JSON.stringify(["8LXyNpkdnCKCCaUWBku1wD2B1HHaZ41FRgFEN6jNmytv"])),
        },
      ],
    }),
    headers: {
      "content-type": "application/json",
      "Solana-ForwardingPolicy": 
        "8LXyNpkdnCKCCaUWBku1wD2B1HHaZ41FRgFEN6jNmytv",
      // ]),
    },
  });
